...
* Developing - **npm start** - Runs the development server at _localhost:8080_ and use Hot Module Replacement. You can override the default host and port through env (`HOST`, `PORT`).
...
_react-component-boilerplate_ is available under MIT. See LICENSE for more details.

    ...
    <Tumblr small={small}>
      <Icon solid={solid} solidcircle={solidcircle} aria-hidden="true">
        ...
        { solid && medium ? <Fragment>
            <TumblrIconFill /> Tumblr </Fragment> : null}
        { solid && big ? <Fragment>
            <TumblrIconFill /> Share on Tumblr </Fragment> : null}
          { (solidcircle || circle ) && small ? <TumblrIconCircle /> : null }
          { (solidcircle || circle ) && medium ? <Fragment>
            <TumblrIconCircle /> Tumblr </Fragment> : null }
          { (solidcircle || circle ) && big ? <Fragment>
            <TumblrIconCircle /> Share on Tumblr </Fragment> : null }
      </Icon>
    </Tumblr>
  </Link>
)

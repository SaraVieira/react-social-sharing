    ...
    <Facebook small={small} solidcircle={solidcircle}>
      <Icon solid={solid} solidcircle={solidcircle} aria-hidden="true">
        ...
        {solid && medium ? <Fragment>
          <FacebookIconFill /> Facebook </Fragment> : null}
        {solid && big ? <Fragment>
          <FacebookIconFill /> Share on Facebook </Fragment> : null}
        {(solidcircle || circle) && small ? <FacebookIconCircle /> : null}
        {(solidcircle || circle) && medium ? <Fragment>
          <FacebookIconCircle /> Facebook </Fragment> : null}
        {(solidcircle || circle) && big ? <Fragment>
          <FacebookIconCircle /> Share on Facebook </Fragment> : null}
      </Icon>
    </Facebook>
  </Link>
)
